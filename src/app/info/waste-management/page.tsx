...
const coletaData: ColetaBairro[] = [
    ...
    { bairro: "Área Central", dias: "Segunda a Sexta, Sábado e Domingo", periodo: "Noite", horario: "Seg-Sex: 19h às 01h, Sáb: 14h às 18h, Dom: 6h às 12h", obs: "Solicitamos que moradores coloquem o lixo uma hora antes do caminhão coletor passar." },
    { bairro: "Vila Pinto", dias: "Terça e Quinta, Sábado", periodo: "Noite", horario: "Terça e Quinta 19h às 1h / Sábado 14h às 18h", obs: "Solicitamos que moradores coloquem o lixo uma hora antes do caminhão coletor passar." },
];
                            ...
                            <div className="flex items-center">
                             ...
                             {resultado.obs && (
                                <div className="flex items-start text-sm mt-2">
                                    ...
                                    <p><strong className="font-medium">Atenção:</strong> {resultado.obs}</p>
                                </div>
                            )}
                            </CardContent>
                        </Card>
