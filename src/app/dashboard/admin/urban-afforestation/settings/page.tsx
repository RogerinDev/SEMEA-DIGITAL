...
export default function UrbanAfforestationSettingsPage() {
  ...
  async function onSubmit(data: z.infer<typeof settingsSchema>) {
    ...
    const result = await updateUrbanAfforestationSettings(data);
    if (result.success) {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Gerencie os projetos de arborização exibidos na página pública.</CardDescription>
            </CardHeader>
